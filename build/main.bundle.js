...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* global fetch, document */
  ...
  **/
  ...
  _createClass(Game, [{
    ...
    */
    ...
    key: '_prePlayMethods',
    value: function _prePlayMethods() {
    ...
    **/
    ...
    value: function _setPoints() {
      var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'No Win.';
      ...
      var points = parseInt(document.querySelector('#points').innerHTML);
      var total = points + increment;
    ...
    **/
    ...
    key: '_updatePointCounter',
    value: function _updatePointCounter(points, total, object) {
      setTimeout(function () {
    ...
    value: function _requestServer() {
      ...
      var localPromise = new Promise(function (resolve, reject) {
        fetch('http://localhost:1337/casino', {
          ...
          _this2._setTitle('Server Down!! Restart Server!.');
        });
      });
      return localPromise;
    }
